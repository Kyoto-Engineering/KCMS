    ...
    public partial class ForSalseClientMP : Form
    {
        ...
        private void dataGridView1_CellMouseClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                frm.clientNameAPTextBox.Text = dr.Cells[3].Value.ToString();
                frm.cmbClientType.Text = dr.Cells[4].Value.ToString();
                frm.cmbNatureOfClient.Text = dr.Cells[5].Value.ToString();
                frm.emailAddressAPTextBox.Text = dr.Cells[6].Value.ToString();
                frm.cmbIndustryCategory.Text = dr.Cells[7].Value.ToString();
                frm.endUserAPTextBox.Text = dr.Cells[8].Value.ToString();

                frm.contactPersonNameAPTextBox.Text = dr.Cells[9].Value.ToString();
                frm.designationAPTextBox.Text = dr.Cells[10].Value.ToString();
                frm.cellNumberAPTextBox.Text = dr.Cells[11].Value.ToString();
                frm.txtCPEmailAddress.Text = dr.Cells[12].Value.ToString();


                frm.cFlatNoTextBox.Text = dr.Cells[13].Value.ToString();
                frm.cHouseNoTextBox.Text = dr.Cells[14].Value.ToString();
                frm.cRoadNoTextBox.Text = dr.Cells[15].Value.ToString();
                frm.cBlockTextBox.Text = dr.Cells[16].Value.ToString();
                frm.cContactNoTextBox.Text = dr.Cells[17].Value.ToString();
                frm.cAreaTextBox.Text = dr.Cells[18].Value.ToString();

                frm.cDivisionCombo.Text = dr.Cells[19].Value.ToString();
                frm.cDistrictCombo.Text = dr.Cells[20].Value.ToString();
                frm.cThanaCombo.Text = dr.Cells[21].Value.ToString().Trim();
                frm.cPostOfficeCombo.Text = dr.Cells[22].Value.ToString();
                frm.cPostCodeTextBox.Text = dr.Cells[23].Value.ToString();


                frm.tFlatNoTextBox.Text = dr.Cells[24].Value.ToString();
                frm.tHouseNoTextBox.Text = dr.Cells[25].Value.ToString();
                frm.tRoadNoTextBox.Text = dr.Cells[26].Value.ToString();
                frm.tBlockTextBox.Text = dr.Cells[27].Value.ToString();
                frm.tContactNoTextBox.Text = dr.Cells[28].Value.ToString();
                frm.tAreaTextBox.Text = dr.Cells[29].Value.ToString();

                frm.tDivitionCombo.Text = dr.Cells[30].Value.ToString();
                frm.tDistComboBox.Text = dr.Cells[31].Value.ToString();
                frm.tThanaCombo.Text = dr.Cells[32].Value.ToString().Trim();
                frm.tPostOfficeCombo.Text = dr.Cells[33].Value.ToString();
                frm.tPostCodeTextBox.Text = dr.Cells[34].Value.ToString();

                frm.bFlatNoTextBox.Text = dr.Cells[35].Value.ToString();
                frm.bHouseNoTextBox.Text = dr.Cells[36].Value.ToString();
                frm.bRoadNoTextBox.Text = dr.Cells[37].Value.ToString();
                frm.bBlockTextBox.Text = dr.Cells[38].Value.ToString();
                frm.bAreaTextBox.Text = dr.Cells[39].Value.ToString();
                frm.bContactNoTextBox.Text = dr.Cells[40].Value.ToString();

                frm.bDivisionCombo.Text = dr.Cells[41].Value.ToString();
                frm.bDistrictCombo.Text = dr.Cells[42].Value.ToString();
                frm.bThanaCombo.Text = dr.Cells[43].Value.ToString();
                frm.bPostOfficeCombo.Text = dr.Cells[44].Value.ToString();
                frm.bPostCodeTextBox.Text = dr.Cells[45].Value.ToString();

                frm.bankNameTextBox.Text = dr.Cells[46].Value.ToString();
                frm.branchNameTextBox.Text = dr.Cells[47].Value.ToString();
                frm.accountNoTextBox.Text = dr.Cells[48].Value.ToString();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            this.Visible = false;
            dynamic af = new ConvertToSalesClientGrid();
            af.ShowDialog();
            this.Visible = true;
        } 
